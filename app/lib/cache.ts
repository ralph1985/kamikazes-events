...
export function getCachedJson<T>(key: string, ttlMs: number = CACHE_TTL_MS): T | null {
...
export function setCachedJson<T>(key: string, data: T, ttlMs: number = CACHE_TTL_MS) {
